...
class TunerConstants:
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 2.94
    ...
    _front_left_x_pos: units.meter = inchesToMeters(9.25)
    _front_left_y_pos: units.meter = inchesToMeters(8)
    ...
    _front_right_x_pos: units.meter = inchesToMeters(9.25)
    _front_right_y_pos: units.meter = inchesToMeters(-8)
    ...
    _back_left_x_pos: units.meter = inchesToMeters(-9.25)
    _back_left_y_pos: units.meter = inchesToMeters(8)
    ...
    _back_right_x_pos: units.meter = inchesToMeters(-9.25)
    _back_right_y_pos: units.meter = inchesToMeters(-8)
